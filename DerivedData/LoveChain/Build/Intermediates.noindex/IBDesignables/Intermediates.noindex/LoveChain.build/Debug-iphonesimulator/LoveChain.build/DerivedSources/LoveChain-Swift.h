...
#ifndef LOVECHAIN_SWIFT_H
#define LOVECHAIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LoveChain",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9LoveChain11AppDelegate")
...
@interface ButtonCustomClass : UIButton
...
@property (nonatomic) IBInspectable BOOL roundedCornersOnRight;
@property (nonatomic) IBInspectable BOOL roundedCornersOnLeft;
...
SWIFT_CLASS("_TtC9LoveChain18MainViewController")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified enterToAccount;
- (void)viewDidLoad;
- (IBAction)registrationVC:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC9LoveChain27RegistrationViewController2")
...
SWIFT_CLASS("_TtC9LoveChain27RegistrationViewController3")
...
SWIFT_CLASS("_TtC9LoveChain13SceneDelegate")
